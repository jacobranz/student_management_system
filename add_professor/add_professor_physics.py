...
class AddProfessor_Physics101(ctk.CTkFrame):
    ...
    def add_professor(self):
        ...
        self.cursor.execute("select professor_ID from course where name = 'Physics 101'")
        ...
        if len(course_info) > 0:
            ...
            #self.cursor.execute("insert into course values (1, 'Physics 101', 4, %s)", (prof,))
            self.cursor.execute("update course set professor_ID = %s where course_ID = 1", (prof,))
            self.mydb.commit()
