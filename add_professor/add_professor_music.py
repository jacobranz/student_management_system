...
class AddProfessor_Music100(ctk.CTkFrame):
    ...
    def add_professor(self):
        ...
        self.cursor.execute("select professor_ID from course where name = 'Music 100'")
        ...
        if len(course_info) > 0:
            ...
            #self.cursor.execute("insert into course values (4, 'Music 100', 4, %s)", (prof,))
            self.cursor.execute("update course set professor_ID = %s where course_ID = 4", (prof,))
            self.mydb.commit()
